...
$product = $connect->query("SELECT * FROM product WHERE id = ".$_GET['id']." LIMIT 1")->fetch_assoc();
...
<body class="d-flex flex-column h-100">
    ...
    <div class="col-lg-8 mx-auto p-3 py-md-5">
        ...
        <div class="row g-5">
            ...
            <form class="needs-validation" action="modify_product.php" method="post" enctype="multipart/form-data" novalidate>
            <input type="hidden" name="id" value="<?=$product['id']?>">
                <div class="row g-3">
                    <div class="col-md-12">
                        <label for="description" class="form-label">Description</label>
                        <input type="text" class="form-control" name="description" maxlength="255" placeholder="" value="<?=$product['description']?>" required>
                    </div>
                </div>
                <div class="row g-3">
                    <div class="col-md-6">
                        <label for="price" class="form-label">Price</label>
                        <input type="text" class="form-control" name="price" maxlength="255" placeholder="00.00" value="<?=$product['price']?>" required data-inputmask="'alias': 'currency'">
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row g-3 p-2 d-flex justify-content-end">
                    <button class="w-25 btn btn-primary" type="submit">Update product</button>
                </div>
            </form>
        </div>
    </div>
